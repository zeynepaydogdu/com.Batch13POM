...
public class C1_windowHandleWithReusableMethods {
    ...
    public void test01(){
        ...
        ReusableMethods.waitFor(10);// THROWA EXPECTION ATMADAN SANIYE HESABI YAZMAMIZI SAGLIYR
...
/*eski yazdigimiz kodu yoruma aldi ve yukarda atni islemi bir methotla reusble ile yaptik

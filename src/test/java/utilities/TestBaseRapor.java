...
public abstract class TestBaseRapor {
    ...
    public void setUpTest() {
        extentReports = new ExtentReports();//html dosyasi olustutrr
        //rapor oluştuktan sonra raporunuz nereye eklensin istiyorsanız buraya yazıyorsunuz.
        String filePath = System.getProperty("user.dir") + "/test-output/Rapor.html";//proje mizin pathi +istedigimiz rapor adimiz
        //+ dan sonra sakla onemli html yazinca yukarda silmeyecegimizi belirten dosya olusturuyor
        //oluşturmak istediğimiz raporu (html formatında) başlatıyoruz, filePath ile dosya yolunu belirliyoruz.
        extentHtmlReporter = new ExtentHtmlReporter(filePath);
        extentReports.attachReporter(extentHtmlReporter);
        // İstediğiniz bilgileri buraya ekeyebiliyorsunuz.
        extentReports.setSystemInfo("Enviroment","QA");//sistemle ilgili bilgiler verir
